...
import 'package:complete_clean_app/vendor/views/screens/vendorProductInfo/vendor_product_info.dart';
              ...
              child:  InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context){
                    return VendorProductInfo(productData: vendorProductData,);
                  }));
                },
                child: Padding(
  ...
  startActionPane: ActionPane(
    ...
    children:  [
      ...
      SlidableAction(
        ...
        backgroundColor: Color.fromARGB(255, 78, 79, 78),
